...
class CompanyForm
{
    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Tabs::make('Firma çalışma alanı')
                    ->persistTabInQueryString('firma-sekmesi')
                    ->columnSpanFull()
                    ->tabs([
                        Tab::make('Profil')
                            ...
                            ->schema([
                                Section::make('Firma Bilgileri')
                                    ->description('Önce temel profili tamamlayın. Yayın URL’si yalnızca yeni kayıtta üretilir.')
                                    ->schema([
                                        Grid::make(2)
                                            ->schema([
                                                TextInput::make('name')
                        ...
                        Tab::make('Görseller')
                            ...
                            ->schema([
                                Section::make('Marka Görselleri')
                                    ->description('Logo ve kapak görseli firma kartı ile profil başlığında kullanılır.')
                                    ->schema([
                                        Grid::make(2)
                                            ->schema([
                                ...
                                Section::make('Fotoğraf Galerisi')
                                    ->description('Sürükle-bırak ile çoklu fotoğraf yükleyin ve sıralayın. En fazla 20 görsel, her biri 10 MB olabilir.')
                                    ->schema([
                        ...
                        Tab::make('İçerik')
                            ...
                            ->schema([
                                ...
                                Section::make('Neden Bu Firma?')
                                    ->description('Firma detay sayfasında profili güçlendiren öne çıkan özellikler')
                                    ->schema([
                                ...
                                Section::make('Dış Bağlantılar')
                                    ->description('Profilde yorumların üzerinde gösterilecek faydalı bağlantılar')
                                    ->collapsed()
                                    ->schema([
                        ...
                        Tab::make('Yayın ve SEO')
                            ->icon('heroicon-o-sparkles')
                            ->schema([
                                Section::make('Yayın Durumu')
                                    ->description('Profilin rehberdeki görünürlüğünü buradan yönetin.')
                                    ->schema([
                                        Grid::make(2)
                                            ->schema([
                                ...
                                Section::make('Arama Sonucu Bilgileri')
                                    ->description('Boş bırakırsanız rehber, firma bilgisinden otomatik başlık ve açıklama üretir.')
                                    ->schema([
