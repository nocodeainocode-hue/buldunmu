...
class ImportCompanies extends Page
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Excel veya CSV yükle')
                ...
                ->schema([
                    ...
                    Toggle::make('autoCreateTaxonomies')
                        ->label('Eksik ortak kategori, şehir ve ilçeleri oluştur')
                        ->helperText('Dikkat: Açıkken yeni kayıt tüm rehberlerin ortak kataloğuna eklenir. Kapalıysa eşleşmeyen satırlar hata raporuna yazılır.'),
                ])->columns(2),
        ])->statePath('data');
    }
