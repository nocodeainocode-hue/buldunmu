...
class CityController extends Controller
{
    public function other(Request $request)
    {
        ...
        $hasIndexableCompanies = Company::searchIndexable()->where($outsideVisibleCities)->exists();
        $isOtherCities = true;
        ...
        return view('frontend.cities.show', compact(
            ...
            'totalInCity', 'hasIndexableCompanies', 'isOtherCities', 'nearbyCities', 'seoContent', 'posts'
        ));
    }
    ...
    public function show(string $slug, Request $request)
    {
        ...
        $hasIndexableCompanies = Company::searchIndexable()
            ->where('city_id', $city->id)
            ->exists();

        return view('frontend.cities.show', compact(
            'city', 'companies', 'districts', 'directory', 'popularCategories',
            'nearbyCities', 'seoContent', 'posts', 'totalInCity', 'hasIndexableCompanies'
        ));
    }
