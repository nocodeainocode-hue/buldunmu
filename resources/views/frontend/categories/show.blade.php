...
@section('robots', $hasIndexableCompanies && !request()->has('city') ? 'index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1' : 'noindex,follow,max-image-preview:large')
